...
const App = () => {
  ...
  const proyectos = [
    { id: 1, img: image11p, descripcion: 'Proyecto 1' ,link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 2, img: image12p, descripcion: 'Proyecto 2', link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 3, img: image13p, descripcion: 'Proyecto 3' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 4, img: image14p, descripcion: 'Proyecto 4', link: 'https://storegitm1-production.up.railway.app/form-1'  },
    //{ id: 5, img: image15p, descripcion: 'Proyecto 5' },
    { id: 6, img: image16p, descripcion: 'Proyecto 6' , link: 'https://storegitm1-production.up.railway.app/form-1' },
   // { id: 7, img: image17pro, descripcion: 'Proyecto 7' },
    //{ id: 8, img: image18pro, descripcion: 'Proyecto 8' },
    { id: 9, img: image19pro, descripcion: 'Proyecto 9' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 10, img: image20pro, descripcion: 'Proyecto 10' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    //{ id: 11, img: image21pro, descripcion: 'Proyecto 11' },
    { id: 12, img: image22pro, descripcion: 'Proyecto 12' , link: 'https://storegitm1-production.up.railway.app/form-1' },
   // { id: 13, img: image23pro, descripcion: 'Proyecto 13' },
    { id: 14, img: image24pro, descripcion: 'Proyecto 14' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 15, img: image25pro, descripcion: 'Proyecto 15' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 16, img: image26pro, descripcion: 'Proyecto 16' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    ...
    { id: 20, img: image30pro, descripcion: 'Proyecto 20' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    //{ id: 21, img: image31pro, descripcion: 'Proyecto 21' },
    { id: 21, img: image32pro, descripcion: 'Proyecto 22' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 21, img: image33pro, descripcion: 'Proyecto 23' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    //{ id: 21, img: image34pro, descripcion: 'Proyecto 24' },
    { id: 21, img: image35pro, descripcion: 'Proyecto 25', link: 'https://storegitm1-production.up.railway.app/form-1'  },
    { id: 21, img: image36pro, descripcion: 'Proyecto 26' , link: 'https://storegitm1-production.up.railway.app/form-1' },
    { id: 21, img: image37pro, descripcion: 'Proyecto 27' , link: 'https://storegitm1-production.up.railway.app/form-1' }
  ];
