...
import image12p from '../dist/img/12p.webp';
import image12p2 from '../dist/img/12p2.png';
import image13p from '../dist/img/13p.webp';
import image13p2 from '../dist/img/13p2.webp';
import image14p from '../dist/img/14p.webp';
import image14p2 from '../dist/img/14p2.png';
import image15p from '../dist/img/15p.png';
import image15p2 from '../dist/img/15p2.png';
import image16p from '../dist/img/16p.webp';
import image17pro from '../dist/img/17p.png';
import image18pro from '../dist/img/18p.png';
import image19pro from '../dist/img/19p.webp';
import image20pro from '../dist/img/20p.webp';
import image21pro from '../dist/img/21p.png';
import image22pro from '../dist/img/22p.webp';
import image23pro from '../dist/img/23p.png';
import image24pro from '../dist/img/24p.webp';
import image25pro from '../dist/img/25p.png';
import image26pro from '../dist/img/26p.webp';
import image27pro from '../dist/img/27p.png';
import image28pro from '../dist/img/28p.png';
import image29pro from '../dist/img/29p.png';
import image30pro from '../dist/img/30p.webp';
import image31pro from '../dist/img/31p.png';
import image32pro from '../dist/img/32p.webp';
import image33pro from '../dist/img/33p.webp';
import image34pro from '../dist/img/34p.png';
import image35pro from '../dist/img/35p.webp';
import image36pro from '../dist/img/36p.webp';
import image37pro from '../dist/img/37p.webp';
...
const App = () => {
  ...
  const proyectos = [
    ...
    { id: 2, img: image12p, descripcion: 'Crud api rest, Estherium blockchain network, the tools used were the following:', link: 'https://patriciomolinae.com/' ,gitlink: 'https://github.com/Maze000/solidityBlockChain',elementos: ['Solidity', 'Ethereum', 'Smart Contracts', 'Ganache','Nodejs', 'Bootstrap']},
    { id: 3, img: image13p, descripcion: 'Motion capture based video game engine, the tools used were the following:' , link: 'https://drive.google.com/file/d/1eR7bxubBCj2yLHpiYvsW-tFKk4Pqr1LU/view?usp=drive_link' ,gitlink: 'https://patriciomolinae.com/',elementos: ['OpenCV', 'Adobe AIR', 'Adobe Flash', 'Kinect SDK', 'ActionScript', 'C++']},
    ...
    { id: 5, img: image13p2, descripcion: 'Video-game rpg clicker mode, the tools used were the following:', link: 'https://maze000.github.io/newWorldOrder-rpg/'  ,gitlink: 'https://github.com/Maze000/newWorldOrder-rpg?tab=readme-ov-file',elementos: ['HTML', 'CSS', 'JS']},
   ...
   // { id: 13, img: image23pro, descripcion: 'Proyecto 13' },
    ...
    { id: 16, img: image26pro, descripcion: 'Quiz test, the tools used were the following:' , link: 'https://quizjs-production.up.railway.app/' ,gitlink: 'https://github.com/Maze000/quizJs',elementos: ['HTML', 'JS', 'CSS']},
      ...
      <Element name="nombre" className="element-name img0">
        <div className="nameCen">
          <div className="nombre">
            ...
            <h3>Software Engineer JavaScript & Python environments.</h3>
